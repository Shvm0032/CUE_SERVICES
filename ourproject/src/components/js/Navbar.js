                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav d-flex  justify-content-end ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <Link class="nav-link" to="/Ourspeaker" tabindex="-1" aria-disabled="true">
                                Speakers
                                </Link>
                            </li>
                            ...
                            <li class="nav-item dropdown">{/* Help DROPDOWN */}
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark p-3" aria-labelledby="navbarDarkDropdownMenuLink ">
                                    <li className='text-center'><Link class="dropdown-item  p-2" to="/Contactus">Contact Us</Link></li>
                                    <li className='text-center'><Link class="dropdown-item  p-2" to="/Dashboard">Dashboard</Link></li>
                                    <li className='text-center'><Link class="dropdown-item  p-2" to="/Faqrear"> FAQ</Link></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <Link class="nav-link" to="/Add_cart" tabindex="-1" aria-disabled="true">
                        ...
                        <div className="d-flex">
                            <Link to="/login"><button className='buttonLogIn' to="/login"> Log-In</button></Link>
                        </div>
                    </div>
                </div>
            </nav>
